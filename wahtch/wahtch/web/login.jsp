                ...
                <form action="login" method="post">
                    ...
                    <div class="social">
                        ...
                        <div class="social-icons google">
                            <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:9999/Watch/login-google&response_type=code&client_id=495179221908-hrqrs564g8ts8i4oqjagiq8k4uvl1a52.apps.googleusercontent.com&approval_prompt=force">
